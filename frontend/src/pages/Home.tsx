    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
        ...
        <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-2xl shadow-lg p-8 border-2 border-red-200">
          <div className="bg-red-200 w-14 h-14 rounded-xl flex items-center justify-center mb-4">
          ...
          <span className="text-red-700 font-medium">Coming Soon</span>
        </div>

        {/* Research Network Card */}
        <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-2xl shadow-lg p-8 border-2 border-indigo-200">
          <div className="bg-indigo-200 w-14 h-14 rounded-xl flex items-center justify-center mb-4">
